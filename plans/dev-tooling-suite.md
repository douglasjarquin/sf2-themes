...
- [ ] 6. Relocate scripts/generate-previews.py to mise-tasks/generate-previews
...
- [ ] 7. Relocate scripts/generate-web-theme-data.py to mise-tasks/generate-web-theme-data
...
- [ ] 8. Relocate tests/test_cli.sh to mise-tasks/test-cli
...
- [ ] 9. Relocate scripts/build-standalone.py to mise-tasks/build-standalone and fix its self-referencing embedded string
...
- [ ] 17. Create scripts/ci/run-in-dev-container.sh
