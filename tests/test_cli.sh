...
test -f "$test_dir/installed-codex/themes/main.tmTheme"
test -f "$test_dir/installed-codex/themes/main-light.tmTheme"
test -f "$test_dir/installed-codex/themes/ryu-light.tmTheme"
grep -q 'theme = "ryu-light"' "$test_dir/installed-codex/config.toml"
grep -q '#101a3a' "$test_dir/installed-codex/themes/main.tmTheme"
test "$("$repo_dir/sf2-themes" current codex --config-dir "$test_dir/installed-codex")" = "ryu-light"
